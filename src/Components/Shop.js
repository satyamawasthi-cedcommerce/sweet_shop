...
import productCredentials from './Product'
...
export default function Shop(props) {
  ...
  return (
    ...
    <div className='shopDiv'>
      <input type="text" placeholder="Enter the sweet you are looking for" className='search' onChange={searchProduct} value={search}/>
    </div>
